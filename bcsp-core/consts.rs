...
mod tests {
    ...
    fn handshake_pre_mask() {
        use bae_core::cshake::CShakeCustom;
        use crate::cshake_customs::HANDSHAKE_PRE_MASK;
        assert_eq!(HANDSHAKE_PRE_MASK.custom_string(), "BerylsoftCommonSecurityProtocol__HANDSHAKE_PRE_MASK".as_bytes());
